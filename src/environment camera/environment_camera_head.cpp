...
scene_environment_camera_head::scene_environment_camera_head()
{
    ...
    projection = camera_projection::perspective(50.0f * Pi / 180, 1.0f, 0.1f, 1000.0f);
}
...
void draw(mesh_drawable const& drawable, scene_environment_camera_head const& environment)
{
